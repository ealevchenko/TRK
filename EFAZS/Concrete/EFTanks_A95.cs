...
{
    public class EFTanks_A95 : IRepository<Tanks_A95>
    {

        private EFDbContext db;

        public EFTanks_A95(EFDbContext db)
        {
        ...
        public IEnumerable<Tanks_A95> Get()
        {
            try
            {
                return db.Select<Tanks_A95>();
            }
            catch (Exception e)
            {
        ...
        public Tanks_A95 Get(int id)
        {
            try
            {
                return db.Select<Tanks_A95>(id);
            }
            catch (Exception e)
            {
        ...
        public void Add(Tanks_A95 item)
        {
            try
            {
                db.Insert<Tanks_A95>(item);
            }
            catch (Exception e)
            {
        ...
        public void Update(Tanks_A95 item)
        {
            try
            {
                db.Update<Tanks_A95>(item);
            }
            catch (Exception e)
            {
        ...
        public void AddOrUpdate(Tanks_A95 item)
        {
            try
            {
                Tanks_A95 dbEntry = db.Tanks_A95.Find(item.id);
                if (dbEntry == null)
                {
                    Add(item);
                }
        ...
        public void Delete(int id)
        {
            try
            {
                Tanks_A95 item = db.Delete<Tanks_A95>(id);
            }
            catch (Exception e)
            {
        ...
        public Tanks_A95 Refresh(Tanks_A95 item)
        {
            try
            {
                db.Entry(item).State = EntityState.Detached;
                return db.Select<Tanks_A95>(item.id);
            }
            catch (Exception e)
            {
