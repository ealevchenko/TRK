...
{
    public class EFTanks_A92 : IRepository<Tanks_A92>
    {

        private EFDbContext db;

        public EFTanks_A92(EFDbContext db)
        {
        ...
        public IEnumerable<Tanks_A92> Get()
        {
            try
            {
                return db.Select<Tanks_A92>();
            }
            catch (Exception e)
            {
        ...
        public Tanks_A92 Get(int id)
        {
            try
            {
                return db.Select<Tanks_A92>(id);
            }
            catch (Exception e)
            {
        ...
        public void Add(Tanks_A92 item)
        {
            try
            {
                db.Insert<Tanks_A92>(item);
            }
            catch (Exception e)
            {
        ...
        public void Update(Tanks_A92 item)
        {
            try
            {
                db.Update<Tanks_A92>(item);
            }
            catch (Exception e)
            {
        ...
        public void AddOrUpdate(Tanks_A92 item)
        {
            try
            {
                Tanks_A92 dbEntry = db.Tanks_A92.Find(item.id);
                if (dbEntry == null)
                {
                    Add(item);
                }
        ...
        public Tanks_A92 Refresh(Tanks_A92 item)
        {
            try
            {
                db.Entry(item).State = EntityState.Detached;
                return db.Select<Tanks_A92>(item.id);
            }
            catch (Exception e)
            {
