    ...
    public class ClientTRK
    {
        ...
        private Cards GetCardsOfNum(object hi, object lo)
        {
            try
            {
                ...
                if (hi != null && lo != null && (uint)hi>0  && (uint)lo>0)
                {
                    ...
                    azsCards card = ef_card.Get().Where(c => c.Number == ((uint)hi).ToString("000") + "," + ((uint)lo).ToString("00000")).FirstOrDefault();
        ...
        public List<RFID> ReadTagsOPSOfRFID() {
            try
            {
                ...
                ItemValueResult[] res = group.Read(items);
                result_list.Add(new RFID { num_trk = 1, side = 0, card = GetCardsOfNum(res[0].Value, res[1].Value), hi = res[0].Value != null ? res[0].Value as uint? : null, lo = res[1].Value != null ? res[1].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 1, side = 1, card = GetCardsOfNum(res[2].Value, res[3].Value), hi = res[2].Value != null ? res[2].Value as uint? : null, lo = res[3].Value != null ? res[3].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 2, side = 0, card = GetCardsOfNum(res[4].Value, res[5].Value), hi = res[4].Value != null ? res[4].Value as uint? : null, lo = res[5].Value != null ? res[5].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 2, side = 1, card = GetCardsOfNum(res[6].Value, res[7].Value), hi = res[6].Value != null ? res[6].Value as uint? : null, lo = res[7].Value != null ? res[7].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 3, side = 0, card = GetCardsOfNum(res[8].Value, res[9].Value), hi = res[8].Value != null ? res[8].Value as uint? : null, lo = res[9].Value != null ? res[9].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 3, side = 1, card = GetCardsOfNum(res[10].Value, res[11].Value), hi = res[10].Value != null ? res[10].Value as uint? : null, lo = res[11].Value != null ? res[11].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 4, side = 0, card = GetCardsOfNum(res[12].Value, res[13].Value), hi = res[12].Value != null ? res[12].Value as uint? : null, lo = res[13].Value != null ? res[13].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 4, side = 1, card = GetCardsOfNum(res[14].Value, res[15].Value), hi = res[14].Value != null ? res[14].Value as uint? : null, lo = res[15].Value != null ? res[15].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 5, side = 0, card = GetCardsOfNum(res[16].Value, res[17].Value), hi = res[16].Value != null ? res[16].Value as uint? : null, lo = res[17].Value != null ? res[17].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 5, side = 1, card = GetCardsOfNum(res[18].Value, res[19].Value), hi = res[18].Value != null ? res[18].Value as uint? : null, lo = res[19].Value != null ? res[19].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 6, side = 0, card = GetCardsOfNum(res[20].Value, res[21].Value), hi = res[20].Value != null ? res[20].Value as uint? : null, lo = res[21].Value != null ? res[21].Value as uint? : null});
                //result_list.Add(new RFID { num_trk = 6, side = 0, card = GetCardsOfNum((uint)37, (uint)50907), hi = 37, lo = 50907 });
                result_list.Add(new RFID { num_trk = 6, side = 1, card = GetCardsOfNum(res[22].Value, res[23].Value), hi = res[22].Value != null ? res[22].Value as uint? : null, lo = res[23].Value != null ? res[23].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 7, side = 0, card = GetCardsOfNum(res[24].Value, res[25].Value), hi = res[24].Value != null ? res[24].Value as uint? : null, lo = res[25].Value != null ? res[25].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 7, side = 1, card = GetCardsOfNum(res[26].Value, res[27].Value), hi = res[26].Value != null ? res[26].Value as uint? : null, lo = res[27].Value != null ? res[27].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 8, side = 0, card = GetCardsOfNum(res[28].Value, res[29].Value), hi = res[28].Value != null ? res[28].Value as uint? : null, lo = res[29].Value != null ? res[29].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 8, side = 1, card = GetCardsOfNum(res[30].Value, res[31].Value), hi = res[30].Value != null ? res[30].Value as uint? : null, lo = res[31].Value != null ? res[31].Value as uint? : null });
                result_list.Add(new RFID { num_trk = 9, side = 0, card = GetCardsOfNum(res[32].Value, res[33].Value), hi = res[32].Value != null ? res[32].Value as uint? : null, lo = res[33].Value != null ? res[33].Value as uint? : null });
                return result_list;
            }
            catch (Exception e)
            {
