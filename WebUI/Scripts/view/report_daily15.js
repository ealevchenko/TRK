            ...
            initObject: function () {
                this.obj = this.html_table.DataTable({
                    ...
                    columns: [
                        ...
                        { data: "dens_coming", title: "Приход плотность (кг)", width: "50px", orderable: true, searchable: true },
                        { data: "temp_coming", title: "Приход темп.", width: "50px", orderable: true, searchable: true },
                        { data: "volume15_coming", title: "Приход привед. к 15 град. (л)", width: "50px", orderable: true, searchable: true },
                        { data: "mass15_coming", title: "Приход привед. к 15 град. (кг)", width: "50px", orderable: true, searchable: true },
                        { data: "dens15_coming", title: "Приход плотность привед. к 15 град. (кг)", width: "50px", orderable: true, searchable: true },
