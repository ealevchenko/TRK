...
/****** Object:  StoredProcedure [dbo].[ADD_Daily_Report_DC]    Script Date: 15.07.2019 00:52:00 ******/
SET ANSI_NULLS ON
GO
...
---- Проверим наличие таблицы [10.21.4.168].[KRR-PA-CNT-Oil].[dbo].[Daily_Report_AZS] если нет создадим
--if OBJECT_ID(N'[10.21.4.168].[KRR-PA-CNT-Oil].[dbo].[Daily_Report_AZS]',N'U') is null
--begin
--	CREATE TABLE [10.21.4.168].[KRR-PA-CNT-Oil].[dbo].[Daily_Report_AZS](
